...
{
#ifdef _WIN32
    Sleep(milliseconds); // Sleep in milliseconds on Windows
#else
    usleep(milliseconds * 1000); // Sleep in microseconds on macOS
#endif
}

// Define a cross-platform function to clear the screen
void clearScreen()
{
#ifdef _WIN32
    system("cls"); // Clear screen on Windows
#else
    system("clear"); // Clear screen on macOS and Linux
#endif
}
...
signed main()
{
    while (true)
    {
        clearScreen(); // Clear's output screen
        landing();
        int ope;
        cin >> ope;
        switch (ope)
...
void landing()
{
    ...
    cout << "\n\t[1] Main Menu" << endl;
    SleepX(10);
    cout << "\t[2] Open Recycle Bin" << endl;
    SleepX(10);
    cout << "\t[3] Meet The Developer's" << endl;
    SleepX(10);
...
void menu()
{
    ...
    SleepX(10);
    cout << "\t[3] View all Student's Info." << endl;
    SleepX(10);
    cout << "\t[4] Update any Student's Info." << endl;
    SleepX(10);
    cout << "\t[5] Delete any Student's Info." << endl;
    SleepX(10);
    cout << "\t[6] Delete All Student's Info." << endl;
    SleepX(10);
    cout << "\t[7] Restore deleted Info." << endl;
    SleepX(10);
    cout << "\t[9] Return to Home." << endl;
    SleepX(10);
    cout << "\t[0] Exit The program." << endl;
    SleepX(10);
    cout << "\t=============================================\n";
    ...
    if (toEdit != NULL)
    {
        ...
        while (edit)
        {
            ...
            case 5:
            {
                ...
                if (toEdit->course.find(cCode) == toEdit->course.end())
                {
                    cout << "\n\t" << toEdit->name << " is not enrolled in this course." << endl
                         << endl;
                }
                else
                {
